...
LOCAL_SHARED_LIBRARIES := liblog libcutils libion_google libutils libsync libhardware
...
ifeq ($(BOARD_GRALLOC_PROTECTED_ION_FLAG_FOR_CAMERA_RESERVED), true)
LOCAL_CFLAGS += -DGRALLOC_PROTECTED_ION_FLAG_FOR_CAMERA_RESERVED
endif
...
LOCAL_SHARED_LIBRARIES := liblog libcutils libion_google libutils android.hardware.graphics.allocator@2.0 android.hardware.graphics.mapper@2.0 \
