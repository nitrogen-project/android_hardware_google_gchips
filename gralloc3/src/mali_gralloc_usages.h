...
typedef enum
{
	...
	GRALLOC1_PRODUCER_USAGE_PROTECTED_DPB                  = GRALLOC1_PRODUCER_USAGE_PRIVATE_0,
	GRALLOC1_PRODUCER_USAGE_CAMERA_RESERVED                = GRALLOC1_PRODUCER_USAGE_PRIVATE_2,
	GRALLOC1_PRODUCER_USAGE_SECURE_CAMERA_RESERVED         = GRALLOC1_PRODUCER_USAGE_PRIVATE_3,
	...
	GRALLOC1_CONSUMER_USAGE_YUV_RANGE_FULL                 = GRALLOC1_CONSUMER_USAGE_PRIVATE_4,
	GRALLOC1_CONSUMER_USAGE_DAYDREAM_SINGLE_BUFFER_MODE    = GRALLOC1_CONSUMER_USAGE_PRIVATE_5,
	GRALLOC1_CONSUMER_USAGE_VIDEO_PRIVATE_DATA             = GRALLOC1_CONSUMER_USAGE_PRIVATE_7,

	GRALLOC1_PRODUCER_USAGE_HFR_MODE                       = GRALLOC1_PRODUCER_USAGE_PRIVATE_10,

        /* FaceAuth specific usages */
	GS101_GRALLOC_USAGE_TPU_INPUT                          = GRALLOC1_CONSUMER_USAGE_PRIVATE_8,
	GS101_GRALLOC_USAGE_TPU_OUTPUT                         = GRALLOC1_PRODUCER_USAGE_PRIVATE_6,
	GS101_GRALLOC_USAGE_CAMERA_STATS                       = GRALLOC1_PRODUCER_USAGE_PRIVATE_7,
...
#endif
#if GRALLOC_VERSION_MAJOR >= 1
    GRALLOC1_PRODUCER_USAGE_PROTECTED_DPB |
    GRALLOC1_PRODUCER_USAGE_PRIVATE_NONSECURE |
    GRALLOC1_PRODUCER_USAGE_CAMERA_RESERVED |
    GRALLOC1_PRODUCER_USAGE_SECURE_CAMERA_RESERVED |
    GRALLOC1_PRODUCER_USAGE_NOZEROED |
    GRALLOC1_CONSUMER_USAGE_YUV_RANGE_FULL |
    GRALLOC1_CONSUMER_USAGE_DAYDREAM_SINGLE_BUFFER_MODE |
